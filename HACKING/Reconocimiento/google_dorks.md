...
- Es importante tener en cuenta que la técnica de Google Dorking no es ilegal en sí misma, pero puede ser utilizada con fines maliciosos. Por lo tanto, es crucial utilizar esta técnica con responsabilidad y ética en el contexto de la seguridad informática y el hacking.

>Para saber los metadatos de un documento usamos la herramientra exiftool y para obtener los docs con la herramineta wget
